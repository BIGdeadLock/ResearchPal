...
@pipeline
def feature_engineering(requesters_full_names: list[str], wait_for: str | list[str] | None = None) -> list[str]:
    raw_documents = fe_steps.query_data_warehouse(requesters_full_names, after=wait_for)
